...
if (isset($_POST['submit'])) {
  ...
  $sql = mysqli_query($conn, "INSERT INTO `description`(`Result`, `Image`, `Description`, `Keywords`) VALUES ('$option', '$imageName','$desc','$keyword')");
  if($sql) echo "<script>alert('New Description uploaded');</script>";
...
<section class="container">
	<div class="row">
		...
		<div class="col-lg-8 col-md-8 col-sm-8 col-12">
				<div>
					<h5 style="color: gray;" class="p-3">Send Description</h5>
				</div>
		<div class="model">
			<form action="" method="post" enctype="multipart/form-data" class="container">
				...
				<div class="p-2">
					<label for="desc">Descripton</label><br>
