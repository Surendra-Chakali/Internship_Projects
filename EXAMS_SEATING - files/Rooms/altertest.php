      ...
      <div>
        <table class="Room-table">
              ...
              <tr class='main-row'>
                  ...
                  <tr class='main-row'><?php $count=1;$count1=1;//$count1=1; ?>
                     ...
                     <td>
                      ...
                      <?php $rownum1=mysqli_fetch_assoc($retvalnum1);?>
                        <td height="100" class="main-data "><center><?php $no1=$rownum1['enrollnumber']; echo $no1;  ?></center><hr>
                            <center><?php $no2=$rownum1['department']; echo $no2 ;  ?></center> </td><!--first branch student seat here-->
                      ...
                      <?php if(($col%2!=0)){?>
                        <tr class='main-row'>
                            <td height="100" class="main-data "><center><?php  echo "----- " ?></center><hr>
                            <center><?php  echo "----"?></center> </td>
                            <td> <?php echo "$row  $col"?>
                     <?php }?>
                      <?php }?>
                    </table>
