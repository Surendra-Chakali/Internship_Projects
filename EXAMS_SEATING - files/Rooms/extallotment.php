...
$sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub department = '$dept' ");
...
while ($result = mysqli_fetch_assoc($sql)) {
  ...
  elseif ($count1 <= 194) {
    ...
    mysqli_query($conn,"INSERT INTO trisub values('$year', '$dept', '$rlnum', 'computerLab1', '$subject', '$examdate', '$starttime', '$endtime')");
    $i++;
    $count1++;
    }
  }
 ...
 $sql1 = mysqli_query($conn,"SELECT COUNT(classroom) AS classroom FROM trisub WHERE classroom='A31' ");
