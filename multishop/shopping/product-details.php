...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	 $sql = mysqli_query($con,"insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
	if ($sql) {
		# code...
		echo "<script>alert('Thanks fro your review');</script>";
	}
					...
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<form action="my-cart.php">
								<input type="hidden" name="rid" value="<?php echo $rw['id']; ?>">
								<a href="my-cart.php?rid=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Add to cart</a>
							</form>
