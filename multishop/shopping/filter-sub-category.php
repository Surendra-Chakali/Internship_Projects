...
while($row=mysqli_fetch_array($sql))
{
    ?>
			...
			<?php } ?>
				...
				<a href="#" style="font-size: 18px;border: none;text-decoration: underline;">Filter by Price -></a>
			</div>
								<div class="row">									
			<?php
...
if ($userId == 0) {
	# code...
	$ret=mysqli_query($con,"select * from products where subCategory='$cid' order by productPrice ASC");
}
else
{
$ret=mysqli_query($con,"select * from products where subCategory='$cid' and $user_age >= agefrom and $user_age <= ageto ");
}
