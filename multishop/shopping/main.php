...
<!-- ================================== TOP NAVIGATION : END ================================== -->
	...
	<a href="chat/index.php"><img src="assets/images/chatbot.png" style="width: 80px;height: 80px;border-radius: 50%;"></a>
</div>
...
$ret=mysqli_query($con,"select * from products where $user_age >= agefrom and $user_age <= ageto ");
}
...
{
$ret=mysqli_query($con,"select * from products where category=3 and $user_age >= agefrom and $user_age <= ageto ");
}
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
...
{
// $phoneerror = "";
// $ret=mysqli_query($con,"select * from products where category=4 and subCategory=4 and $user_age >= agefrom and $user_age <= ageto ");
...
<?php }
					// else
					// {
					// 	$phoneerror = "oops! No product found for you";
					// }}
					?>

	<p><?php echo "<h5 class = 'text-left'>$phoneerror</h5>";?></p>
			                   	</div>
	                   </section>
					</div>
					<div class="col-md-6">
...
{
$ret=mysqli_query($con,"select * from products where category=4 and subCategory=6 and $user_age >= agefrom and $user_age <= ageto ");
}
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
{
// 			$fashionerror = "";
// $ret=mysqli_query($con,"select * from products where category=6 and $user_age >= agefrom and $user_age <= ageto ");
// $row1=mysqli_fetch_array($ret);
...
?>
				...
				// else{
				//  $fashionerror = "No Product found for you"; 
				// }

				?>
				<p><?php echo "<h4 class = 'text-center'>$fashionerror</h4>";?></p>
							</div>
		</section>
