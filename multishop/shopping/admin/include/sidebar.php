...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="insert-related-item.php"><i class="menu-icon icon-paste"></i>Insert Related products </a></li>
                                <li><a href="manage-products.php"><i class="menu-icon icon-table"></i>Manage Products </a></li>
                                <li><a href="manage-reviews.php"><i class="menu-icon icon-table"></i>Manage Reviews </a></li>
